        ...
        <div class="col-sm-6 col-md-4 col-md-offset-4">
            ...
            <div class="account-wall">
                ...
                <form class="form-signin" method="post" name="loginform">
                    ...
                    <a class="pull-left" href="design\designtemplates\forgotpwd.html" class="text-center new-account">Forgot Password</a>
					<a class="pull-right" href="design\designtemplates\signup.html" class="text-center new-account">New User </a>
                </form>
            </div>
        </div>
    </div>
...
<?php
		...
		if ($conn->connect_error) {
			...
			{ 
				...
				$sql = "SELECT * from login where email_id='$emailid' and password='$psw'";
